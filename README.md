...
local Window = OrionLib:MakeWindow({Name = "DIAMOND HUB V1", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DIAMOND HUB V1"})
...
W:AddLabel("[+] DIAMOND HUB V1 is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "DIAMOND HUB V1(Noitification)",
...
OrionLib:MakeNotification({
        Name = "DIAMOND HUB V1",
        Content = "Script Carregado! Agora Você Pode Usar As Funções!!",
        Image = "rbxassetid://119980140458596",
        Time = 5
    })
...
OrionLib:MakeNotification({
    ...
    Image = "https://media.discordapp.net/attachments/1308177660454768781/1321291201931907154/pngwing.com.png?ex=676cb3d2&is=676b6252&hm=921d068f5daac45509c635da78604364525ca3c7489f87714c01818876c5abcc&",
    Time = 5
})
